...
>
    ...
    <style>
        ...
        .phase2-monitor-badge { background: #eef2f5; border-radius: 3px; color: #687785; font-size: 10px; margin-left: 6px; padding: 1px 6px; text-transform: uppercase; letter-spacing: .02em; }
